...
[![GitHub](https://img.shields.io/badge/github-full--statck--skills%2Fdesign-skills-green.svg)](https://github.com/full-statck-skills/design-skills)
...
```bash
npx skills add full-statck-skills/design-skills --skill <skill-name>
```
...
```bash
git clone https://github.com/full-statck-skills/design-skills.git
